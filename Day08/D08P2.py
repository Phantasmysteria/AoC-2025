...
step = 0
while True:
    data["05-boxes"].union(data["04-pairs"][step][0], data["04-pairs"][step][1])
    if max(data["05-boxes"].sizes) == dataLength:
        break
    step += 1

output = data["01-parsed"][data["04-pairs"][step][0]][0] * data["01-parsed"][data["04-pairs"][step][1]][0]
print(output)
